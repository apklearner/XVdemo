package com.example.xkdemo.pull.lib;
...
import com.example.xkdemo.pull.lib.util.PtrCLog;
...
//            mScrollChecker.tryToScrollTo(PtrIndicator.POS_START, mDurationToCloseHeader);
            mScrollChecker.tryToScrollTo(PtrIndicator.getPosStart(), mDurationToCloseHeader);
        }
    }
