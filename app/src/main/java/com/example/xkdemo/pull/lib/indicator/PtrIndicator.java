package com.example.xkdemo.pull.lib.indicator;
...
public class PtrIndicator {
    ...
    public static int POS_SECOND = 0;

    public static void setPosSecond(int second) {
        POS_SECOND = second;
    }

    public static int getPosStart() {
        return POS_SECOND > 0 ? POS_SECOND : POS_START;
    }
}
